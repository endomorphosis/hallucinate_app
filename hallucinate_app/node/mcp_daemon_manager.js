...
const HAO_754_LAUNCH_VALIDATION_GATE = {
  ...
  failure_rule: 'Any missing HAO-754 launch Playwright validation gate, catalog, daemon health, tools/list, tools/call, Swissknife consumer, or HAO-755 packet sibling evidence remains supervisor-fed launch work for VAIOS-G724 and VAIOS-G728.'
};
