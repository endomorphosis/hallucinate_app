...
const HAO_750_DASHBOARD_INTEROPERABILITY_CONSOLE_GATE = {
  ...
  failure_rule: 'Any HAO-750 catalog normalization, dashboard UI wiring, mediated tools/list, mediated tools/call, Swissknife consumer, backend validation, Playwright coverage, or supervisor-generated follow-up failure remains supervisor-fed launch work for VAIOS-G723.'
};
...
const DASHBOARD_LAUNCH_VALIDATION_GATES = [
  ...
  HAO_750_DASHBOARD_INTEROPERABILITY_CONSOLE_GATE,
  MGW_558_LAUNCH_VALIDATION_GATE,
