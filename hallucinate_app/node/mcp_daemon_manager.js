...
const HAO_729_LAUNCH_VALIDATION_GATE = {
  ...
  validation_gate_contract: 'Headless-safe launch Playwright validation gate must exercise mcp-feature-exposure.spec.ts, mcp-dashboard-interoperability.spec.ts, Swissknife MCP consumers, Meta glasses handoff, and multimodal-control-surface receipts before VAIOS-G723 closes.',
  failure_rule: 'Any HAO-729 dashboard catalog, UI wiring, mediated tools/list, mediated tools/call, Swissknife consumer, backend validation, headless Playwright, or supervisor follow-up failure remains supervisor-generated follow-up work for VAIOS-G723.',
  related_task_ids: ['HAO-729', 'HAO-750'],
  merge_family: 'objective/VAIOS-G723',
  merge_key: '3997b2fdaa13d4a4',
  todo_vector_key: '423c5c08373fafe1'
};
