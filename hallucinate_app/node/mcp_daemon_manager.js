...
const DAEMON_LAUNCH_GATE_VAI_TASK_IDS = ['VAI-519', 'VAI-530', 'VAI-536', 'VAI-538', 'VAI-540', 'VAI-549', 'VAI-555', 'VAI-557', 'VAI-559', 'VAI-562', 'VAI-565'];
    ...
    return [...this.daemonConfigs]
      ...
      .map((config) => ({
        ...
        launch_validation_gates: [
          ...
          {
            task_id: VAI_562_DAEMON_LAUNCH_VALIDATION_GATE.task_id,
            goal_id: DAEMON_LAUNCH_GATE_GOAL_ID,
            evidence_term: 'launch Playwright validation gate',
            playwright_spec: 'hallucinate_app/test/e2e/daemon-launch-health.spec.ts',
            objective_gap_receipt: VAI_562_DAEMON_LAUNCH_VALIDATION_GATE.objective_gap_receipt,
            launch_gate_receipt: VAI_562_DAEMON_LAUNCH_VALIDATION_GATE.launch_gate_receipt
          },
          {
