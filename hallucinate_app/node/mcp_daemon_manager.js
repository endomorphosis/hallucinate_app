...
const VAIOS_G723_DASHBOARD_CHILD_GOALS = [
...
const VAIOS_G723_DASHBOARD_FOLLOW_UP_SUBTASKS = ['HAO-678', 'HAO-679', 'HAO-680', 'HAO-681', 'HAO-682', 'HAO-683'];
const VAIOS_G723_DASHBOARD_REQUIRED_EVIDENCE = [
...
const VAIOS_G723_DASHBOARD_VALIDATION_COMMANDS = [
...
const VAIOS_G723_DASHBOARD_RECEIPT_ROUTE = [
...
const VAIOS_G723_DASHBOARD_SERVERS = [
  {
    daemon_id: 'ipfs-kit',
...
const VAI_543_LAUNCH_VALIDATION_GATE = {
  ...
  validation_commands: VAIOS_G723_DASHBOARD_VALIDATION_COMMANDS,
  required_backends: [
    'ipfs_kit_py',
    'ipfs_datasets_py',
    'ipfs_accelerate_py'
  ],
  required_evidence: VAIOS_G723_DASHBOARD_REQUIRED_EVIDENCE,
  child_goals: VAIOS_G723_DASHBOARD_CHILD_GOALS,
  catalog_source: 'hallucinate_app.node.mcp_daemon_manager.getDashboardCapabilityCatalog',
  catalog_schema: DASHBOARD_CATALOG_SCHEMA,
  catalog_generated_by: 'hallucinate_app.node.mcp_daemon_manager.getDashboardCapabilityCatalog',
  catalog_fixture: 'hallucinate_app/test/e2e/fixtures/vai-512-mcp-dashboard-catalog.json',
  catalog_launch_objective_ids: DASHBOARD_LAUNCH_OBJECTIVE_IDS,
  receipt_route: VAIOS_G723_DASHBOARD_RECEIPT_ROUTE,
  dashboard_servers: VAIOS_G723_DASHBOARD_SERVERS,
  follow_up_subtasks: VAIOS_G723_DASHBOARD_FOLLOW_UP_SUBTASKS,
  failure_rule: 'Any dashboard catalog, UI wiring, mediated tools/list, mediated tools/call, Swissknife consumer, backend validation, or Playwright failure remains supervisor-generated follow-up work for VAIOS-G723.'
};
