...
class ErrorMonitor:
    ...
    def _messages_similar(self, msg1: Any, msg2: Any) -> bool:
        ...
        # runtime), fall back to equality so that re.sub does not raise
        # TypeError and duplicate detection still works for the common case
        # where both sides are the same non-string value.
