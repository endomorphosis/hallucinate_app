...
class ErrorMonitor:
    ...
    def _normalize_similar_message(self, message: str) -> str:
        """Replace volatile error-message details with the collision-safe sentinel."""
    ...
    def _messages_similar(self, msg1: Any, msg2: Any) -> bool:
        ...
        # unrelated errors to be treated as duplicates — the guard applies to
        # the exact-match path as well as the substring path so that e.g.
        # "0xdeadbeef" and "0xcafebabe" (both normalising to that sentinel)
        # are not conflated.
