...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  daemon: {
    ...
    getDashboardCapability: (daemonId) => ipcRenderer.invoke('daemon:getDashboardCapability', daemonId),
    ...
    dashboardHealth: (daemonId) => ipcRenderer.invoke('daemon:dashboardHealth', daemonId),
    dashboardToolsList: (daemonId) => ipcRenderer.invoke('daemon:dashboardToolsList', daemonId),
    dashboardToolsCall: (daemonId) => ipcRenderer.invoke('daemon:dashboardToolsCall', daemonId),
