...
async function runTests() {
  ...
  const catalogSpecificsOk =
    ...
    catalog.launch_validation_gates?.some(gate =>
      gate.task_id === 'MGW-581' &&
      gate.goal_id === 'VAIOS-G723' &&
      gate.launch_gate_receipt === 'data/meta_glasses_display_widgets/discovery/2026-07-08-mgw-581-launch-playwright-validation-gate.md' &&
      gate.hallucinate_backlog_receipt === 'data/hallucinate_multimodal_control/discovery/2026-07-08-mgw-581-mcp-dashboard-launch-gate.md' &&
      gate.receipt_fixture === 'hallucinate_app/test/e2e/fixtures/mgw-581-mcp-dashboard-launch-gate.json' &&
      gate.attempt_receipts?.includes('data/meta_glasses_display_widgets/discovery/2026-07-08-mgw-581-attempt-1-launch-playwright-validation-gate.md') &&
