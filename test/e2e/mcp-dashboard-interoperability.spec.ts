...
test.describe('MCP Dashboard Interoperability - VAIOS-G723 headless backend gate', () => {
  ...
  test('closes the VAI-680 objective gap with the current VAIOS-G724/VAIOS-G728 launch packet gate', () => {
    validateDashboardLaunchGateReceipt({
    ...
    const daemonGate = manager.getDaemonLaunchValidationGates().find((gate: any) => gate.task_id === 'VAI-681');
