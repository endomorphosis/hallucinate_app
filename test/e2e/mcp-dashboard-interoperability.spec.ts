...
test.describe('MCP Dashboard Interoperability - VAIOS-G723 headless backend gate', () => {
  ...
  test('binds MGW-581 objective gap evidence to the active VAIOS-G723 dashboard launch Playwright gate', () => {
    ...
    expect(vai512Catalog.launch_validation_gates.find((gate: any) => gate.task_id === 'MGW-581')).toEqual(launchGate);
