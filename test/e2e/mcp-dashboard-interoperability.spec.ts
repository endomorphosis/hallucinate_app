...
test.describe('MCP Dashboard Interoperability - VAIOS-G723 headless backend gate', () => {
  ...
  test('closes the HAO-727 Hallucinate supervisor mirror with the VAIOS-G723 dashboard launch gate', () => {
    ...
    expect(objectiveHeap).toContain('data/hallucinate_multimodal_control/discovery/2026-06-28-hao-727-mcp-dashboard-launch-gate.md');
