...
const VAI_597_ATTEMPT_1_LAUNCH_GATE_RECEIPT = path.join(
  REPO_ROOT,
  'data',
  'virtual_ai_os',
  'discovery',
  '2026-07-04-vai-597-attempt-1-launch-playwright-validation-gate.md'
);
const VAI_597_ATTEMPT_1_HALLUCINATE_VALIDATION_RECEIPT = path.join(
  REPO_ROOT,
  'data',
  'hallucinate_multimodal_control',
  'discovery',
  '2026-07-04-vai-597-attempt-1-validation.md'
);
...
test.describe('MCP Dashboard Interoperability - VAIOS-G723 headless backend gate', () => {
  ...
  test('binds VAI-597 objective gap evidence to the VAIOS-G723 dashboard launch Playwright gate', () => {
    ...
    const attempt1LaunchGateReceipt = fs.readFileSync(VAI_597_ATTEMPT_1_LAUNCH_GATE_RECEIPT, 'utf8');
    const attempt1HallucinateValidationReceipt = fs.readFileSync(VAI_597_ATTEMPT_1_HALLUCINATE_VALIDATION_RECEIPT, 'utf8');
    ...
    expect(objectiveHeap).toContain('VAI-597 attempt 1 validation');
