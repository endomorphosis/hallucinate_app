  ...
  test('normalizes one dashboard capability catalog across menus and backend services', async () => {
    ...
    expect(catalog?.launch_validation_gates).toEqual(expect.arrayContaining([
      ...
      expect.objectContaining({
        ...
        failure_rule: 'Any VAI-550 dashboard catalog, UI wiring, mediated tools/list, mediated tools/call, Swissknife consumer, backend validation, or Playwright failure remains supervisor-generated follow-up work for VAIOS-G723.'
      })
    ]));
