...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  ipfs: {
    ...
    listPins: () => ipcRenderer.invoke('ipfs:list_pins'),
    stat: (request) => ipcRenderer.invoke('ipfs:stat', request),
    dagGet: (request) => ipcRenderer.invoke('ipfs:dag_get', request),
    dagPut: (request) => ipcRenderer.invoke('ipfs:dag_put', request),
    namePublish: (request) => ipcRenderer.invoke('ipfs:name_publish', request),
    nameResolve: (request) => ipcRenderer.invoke('ipfs:name_resolve', request),
